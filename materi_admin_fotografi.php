...
<body>
    ...
    <main>
        ...
        // Query to retrieve materi data hanya untuk Fotografi (Kls02)
        $query = "SELECT * FROM materi WHERE Id_Kelas = 'Kls02' LIMIT $limit OFFSET $offset";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Get total number of Fotografi materials (Kls02)
        $total_query = "SELECT COUNT(*) as total FROM materi WHERE Id_Kelas = 'Kls02'";
        ...
        <section class="navigation">
            <?php if ($page < $total_pages) { ?>
                <a href="materi_admin_fotografi.php?page=<?php echo $page + 1; ?>"></a>
            <?php } else { ?>
                <a href="quiz_fotografi_admin.php"></a>
            <?php } ?>
        </section>
        ...
        <section class="mulaiQuiz">
            ...
            <?php if ($page < $total_pages) { ?>
                <button onclick="window.location.href='materi_admin_fotografi.php?page=<?php echo $page + 1; ?>'">Next Materi
