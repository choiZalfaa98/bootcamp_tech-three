...
<!--HALAMAN WEB TECHTREE: LANDING PAGE/HOME-->
<!DOCTYPE html>
<html lang="id">
  <head>
  ...
  <body>
    ...
    <header>
      ...
      <nav class="nav_header">
        <a class="navLink" href="landingPage.html">Beranda</a>
        <a class="navLink" href="#footer">Tentang</a>
        <a class="navLink" href="#pilihanKelas">Kursus</a>
      </nav>

      <!--Button Log In and Sign Up-->
      <div id="buttonStyle" class="nav_header">
        <a id="masuk_button" href="login.html" role="button">Masuk</a>
        <a class="buttonBerwarna" href="registrasi.html" role="button">Daftar</a>
      </div>
    </header>
    ...
    <div id="pilihanKelas" class="fotoDanTeks3-grid">
      ...
      <div class="fotoDanTeks2-grid-items">
        ...
        <section class="containerKontenKelas">
          ...
          <a class="lebihLanjutLink" href="registrasi.html">Lebih Lanjut</a>
        </section>
        <!--section kedua-->
        <section class="containerKontenKelas">
          <div class="illustBG">
    ...
    <footer id="footer">
      <div class="footer-grid">
        <!--Clickable Logo-->
        <a id="logo_linkFooter" href="landingPage.html">
