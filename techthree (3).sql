...
--
-- Host: 127.0.0.1:3306
-- Waktu pembuatan: 06 Jun 2024 pada 19.09
...
INSERT INTO `tugas` (`Id_Tugas`, `Nama_Tugas`, `Nilai_Tugas`) VALUES
('Tgf01', 'Kuis 1 Fotografi', 80);
...
INSERT INTO `user` (`Id_User`, `Nama_User`, `Password_User`, `No_Telp_User`, `Nama_Kelas`, `Tanggal_Lahir_User`, `email`, `Id_Admin`) VALUES
('User001', 'Mario Atmaja', 'Atm4j@!!', '085675235233', 'Fotografi', '1998-06-06', NULL, NULL);
...
--
-- Struktur dari tabel `user_tugas`
--
...
--
-- Dumping data untuk tabel `user_tugas`
--

INSERT INTO `user_tugas` (`Id_User`, `Id_Tugas`, `Id_Materi`, `nilai_tugas`) VALUES
('User001', 'Tgf01', 'mf01', 80);
...
--
-- Ketidakleluasaan untuk tabel `user_tugas`
--
ALTER TABLE `user_tugas`
  ADD CONSTRAINT `user_tugas_ibfk_1` FOREIGN KEY (`Id_User`) REFERENCES `user` (`Id_User`),
  ADD CONSTRAINT `user_tugas_ibfk_2` FOREIGN KEY (`Id_Tugas`) REFERENCES `tugas` (`Id_Tugas`),
  ADD CONSTRAINT `user_tugas_ibfk_3` FOREIGN KEY (`Id_Materi`) REFERENCES `materi` (`Id_Materi`);
COMMIT;
